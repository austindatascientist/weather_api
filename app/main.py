...
from .graph_nodes import create_location_node, create_weather_nodes_for_city, create_edges_for_city
...
def create_city_graph_nodes(request: CreateCityGraphNodesRequest):
    ...
    try:
        ...
        nodes_created = create_weather_nodes_for_city(city_name, request.days)
